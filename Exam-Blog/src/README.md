...
5. updateBlog
6. allblogshow
7. getcomment - show comment - The comments that users have made on the blog

User API 
1. register
2. login
3. allblog - Display all blog posts created by the admini
4. singleview of blog
5. addcomment - add comment on the blog 
